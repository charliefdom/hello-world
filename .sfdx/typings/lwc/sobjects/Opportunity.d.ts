...
declare module "@salesforce/schema/Opportunity.Days_to_Close__c" {
  const Days_to_Close__c:number;
  export default Days_to_Close__c;
}
...
declare module "@salesforce/schema/Opportunity.Discount_Percent__c" {
  const Discount_Percent__c:number;
  export default Discount_Percent__c;
}
declare module "@salesforce/schema/Opportunity.Discount_Percent_Status__c" {
  const Discount_Percent_Status__c:string;
  export default Discount_Percent_Status__c;
}
