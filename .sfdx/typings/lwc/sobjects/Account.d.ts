...
declare module "@salesforce/schema/Account.Sum_of_Opportunities__c" {
  const Sum_of_Opportunities__c:number;
  export default Sum_of_Opportunities__c;
}
declare module "@salesforce/schema/Account.Potential_Value__c" {
  const Potential_Value__c:number;
  export default Potential_Value__c;
}
